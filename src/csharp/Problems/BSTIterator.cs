...
public sealed class BSTIterator : ProblemBase
{
    ...
    public override void AddTestCases()
        => Add(it => it.Param<TreeNode>(7,3,15,null,null,9,20).ParamArray("BSTIterator","next","next","hasNext","next","hasNext","next","hasNext","next","hasNext").ResultArray<object>(null,3,7,true,9,true,15,true,20,false));
